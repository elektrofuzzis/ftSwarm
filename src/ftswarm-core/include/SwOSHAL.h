...
const gpio_num_t SERVO[9][4] = 
  { /* FTSWARMJST_1V0 */       { xGPIO_NUM_25,  GPIO_NUM_NC, GPIO_NUM_NC, GPIO_NUM_NC},
    /* FTSWARMCONTROL_1V3 */   { GPIO_NUM_33,   GPIO_NUM_NC, GPIO_NUM_NC, GPIO_NUM_NC},
    /* FTSWARMJST_1V15 */      { xGPIO_NUM_25,  GPIO_NUM_NC, GPIO_NUM_NC, GPIO_NUM_NC},
    /* FTSWARMRS_2V0 */        { xGPIO_NUM_47,  GPIO_NUM_NC, GPIO_NUM_NC, GPIO_NUM_NC},
    ...
    /* FTSWARMXL_1V00 */       { GPIO_NUM_NC,   GPIO_NUM_NC, GPIO_NUM_NC, GPIO_NUM_NC}
  };
