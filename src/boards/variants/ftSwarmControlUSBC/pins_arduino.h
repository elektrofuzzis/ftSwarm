...
static const int8_t       INPUT_IOTYPE[]      = { DIGITALIO,       DIGITALIO,       DIGITALIO,       DIGITALIO,       DIGITALIO,       DIGITALIO,       PWRCTLIO,        JOYSTICKPOTI,    JOYSTICKPOTI,    JOYSTICKPOTI,    JOYSTICKPOTI };
