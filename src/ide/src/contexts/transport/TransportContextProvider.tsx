import {createMemo, createResource, createSignal, Match, type ParentComponent, Switch,} from "solid-js";
import {
...
import type {SwarmToSocketStateUpdate, SwarmToSocketSubscription,} from "../../api/transport/swarm2socket";
import logger from "../../util/logger";
import {OMContext, TransportContext} from "./context";
import {ErrorScreen} from "../../components/ErrorScreen";
import {type DebugContextType, useDebug} from "../DebugContext";
...
class ContextTransportAdapter implements TransportAdapter {
    ...
    async onError(error: CommunicationError): Promise<void> {
        ...
        if (error.resolution() != ErrorResolution.IGNORE) this.setCommunicationError(error);
    }
