...
export const DigitalInput: IoCardRendererComponent<ApiDigitalInputType> = (
  ...
  return (
    <div class="flex items-center justify-between pt-2">
      ...
      <div
        class={`rounded-full border px-4 py-1 text-xs font-bold tracking-wide ${props.io.value ? "bg-thm-ok/20 text-thm-ok border-thm-ok/30" : "border-zinc-700/50 bg-zinc-800/50 text-zinc-500"}`}
      >
