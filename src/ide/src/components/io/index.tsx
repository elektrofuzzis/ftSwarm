...
export function toSequencedDatum<T>(props: IoCardProps, value: T): SequencedDatum<T> {
    return {
        seq: props.seq(),
        data: value
    }
...
export function sequencedDatumFactory<T>(props: IoCardProps, accessor: (props: IoCardProps) => T): () => SequencedDatum<T> {
