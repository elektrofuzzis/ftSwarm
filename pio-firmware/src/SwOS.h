...
// I2C modes
typedef enum { FTSWARM_I2C_OFF, FTSWARM_I2C_MASTER, FTSWARM_I2C_SLAVE, FTSWARM_I2C_FTCSOUNDBAR, FTSWARM_I2C_FTPWRDRIVE, FTSWARM_I2C_TXT, FTSWARM_I2C_FTDUINO } FtSwarmI2CMode_t;
